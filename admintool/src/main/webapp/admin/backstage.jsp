                                ...
                                <c:forEach items="${requestScope.submissions}" var="submission">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${submission.status eq 'Success'}">
                                                <c:set var="color" value="green"/>
                                            </c:if>
                                            <c:if test="${submission.status eq 'Uploaded'}">
                                                <c:set var="color" value="black"/>
                                            </c:if>
                                            <c:if test="${submission.status eq 'Failed'}">
                                                <c:set var="color" value="red"/>
                                            </c:if>
                                        <td style="color: ${color};font-weight: bold">${submission.status}</td>
                                        <td>
