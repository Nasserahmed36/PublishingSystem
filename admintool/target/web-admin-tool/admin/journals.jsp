    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete Jouranl</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Are you sure you want to delete the Jouranl?
            </div>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a style="font-weight: bold"  class="navbar-brand" href="#">Journals</a>
                    <a class="navbar-brand"
                       href="${pageContext.request.contextPath}/journal/form">Journal Form</a>
...
<script>
    ...
    function removeRow(button) {
        ...
        printIssn = row.find('td:first-child').text();
    ...
    function confirmRemove() {
        $.ajax({
            type: "GET",
            url: "http://localhost:8080/AdminTool/journal/delete?pIssn=" + printIssn,
            success: function (data, textStatus, xhr) {
                row.remove();
                notify("Journal Removed")
            },
