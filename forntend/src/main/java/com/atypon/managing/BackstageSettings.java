...
class BackstageSettings {
    ...
    private static final ClassLoader classLoader = com.atypon.managing.BackstageSettings.class.getClassLoader();
    private static final File file = new File(classLoader.getResource("config/settings.properties").getFile());
    private static final Properties properties = new Properties();
    private static final String RESOURCES_PATH = com.atypon.managing.BackstageSettings.class.getResource("/").getPath();
    ...
    static String articlePdf(String outputDir, String articleDoi) {
        return outputDir + File.separator + articleDoi + ".pdf";
    }
