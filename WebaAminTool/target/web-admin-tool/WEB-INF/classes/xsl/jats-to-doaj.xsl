...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="article-meta">
        ...
        <record>
            ...
            <eissn>
                <xsl:value-of select="../title-meta/issn"/>
            </eissn>
            ...
            <doi>
                <xsl:value-of select="article-doi[@pub-doi-type='doi']"/>
            </doi>

            <publisherRecordId>
                <xsl:value-of select="article-doi[@pub-doi-type='publisher-doi']"/>
            </publisherRecordId>
    ...
    <xsl:template match="aff">
        <affiliationName affiliationId="{@doi}">
