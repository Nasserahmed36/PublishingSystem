        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a style="font-weight: bold" class="navbar-brand" href="#">Submissions</a>
                </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="content">
                            <form action="${pageContext.request.contextPath}/articleUpload" method="post"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="seriesISSN" type="text" class="form-control"
                                                   placeholder="Series ISSN">
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" onclick="updateIdentity()" style="margin-left: 10px;"
                                ...
                                <c:forEach items="${requestScope.submissions}" var="submission">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <fmt:formatDate value="${fromattedDate}" pattern="MM/dd/yyyy HH:mm"/>
                                        </td>
