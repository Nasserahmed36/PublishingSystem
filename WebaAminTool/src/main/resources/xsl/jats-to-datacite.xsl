...
<xsl:stylesheet version="1.0"
    ...
    <xsl:variable name="doi" select="/article/front/article-meta/article-doi[@pub-doi-type='doi']"/>
    ...
    <xsl:template match="article-meta">
        ...
        <resource xsi:schemaLocation="http://datacite.org/schema/kernel-3 http://schema.datacite.org/meta/kernel-3/metadata.xsd">
            ...
            <publisher>
                <xsl:apply-templates select="../title-meta/title-title-group/title-title"/>
            </publisher>
            <publicationYear>
    ...
    <xsl:template match="contrib[@contrib-type='author']">
        <creator>
            ...
            <xsl:apply-templates select="contrib-doi[@contrib-doi-type='orcid']"/>
            <!-- TODO: affiliation? -->
        </creator>
    </xsl:template>

    <xsl:template match="contrib-doi[@contrib-doi-type='orcid']">
    ...
    <!--
    <xsl:template match="ref/pub-doi[@pub-doi-type='doi']">
