...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="article-meta">
        <xsl:variable name="title-meta" select="../title-meta"/>
        <xsl:variable name="title-title" select="$title-meta/title-title-group/title-title"/>

        <xsl:variable name="doi" select="article-doi[@pub-doi-type='publisher-doi']/text()"/>
        <xsl:variable name="doi" select="article-doi[@pub-doi-type='doi']/text()"/>
        ...
        <item rdf:about="{$url}">
            ...
            <dc:publisher>
                <xsl:value-of select="$title-meta/publisher/publisher-name"/>
            </dc:publisher>
            <dc:rights>
            ...
            <terms:bibliographicCitation>
                ...
                <xsl:value-of select="concat(volume, ':', elocation-doi)"/>
