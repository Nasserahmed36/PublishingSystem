...
<stylesheet version="1.0" exclude-result-prefixes="xlink"
    ...
    <template match="article-meta">
        <variable name="title-meta" select="../title-meta"/>
        <variable name="title-title" select="$title-meta/title-title-group/title-title"/>

        <variable name="doi" select="article-doi[@pub-doi-type='publisher-doi']/text()"/>
        <variable name="doi" select="article-doi[@pub-doi-type='doi']/text()"/>
        ...
        <!--<x:xmpmeta>-->
            <rdf:RDF>
                <rdf:Description rdf:about="{$uri}">
                    ...
                    <!--TODO-->
                    <dc:publisher>
                        <value-of select="$title-meta/publisher/publisher-name"/>
                    </dc:publisher>
                    <dc:rights>
                        <!--
                        <text>Copyright ©&#160;</text>
                    ...
                    <terms:bibliographicCitation>
                        ...
                        <value-of select="concat($title-title, ' ')"/>
                        <value-of select="concat(volume, ':', elocation-doi)"/>
                    ...
                    <terms:isPartOf rdf:resource="urn:issn:{$title-meta/issn}"/>
                    <terms:license>
                    ...
                    <terms:publisher>
                        <terms:Agent>
                            ...
                            <!--
                                <value-of select="$title-meta/publisher/publisher-loc/uri"/>
                            -->
                            </foaf:homepage>
                        </terms:Agent>
                    </terms:publisher>
                    ...
                    <prism:issn>
                        <value-of select="$title-meta/issn"/>
                    </prism:issn>
                    <prism:volume>
                        <value-of select="volume"/>
                    </prism:volume>
                    <prism:publicationName>
                        <value-of select="$title-meta/title-title-group/title-title"/>
                    </prism:publicationName>
                ...
                <rdf:Description rdf:about="urn:issn:{$title-meta/issn}"
                                 xmlns:dc="http://purl.org/dc/elements/1.1/"
                                 xmlns:bibo="http://purl.org/ontology/bibo/">
