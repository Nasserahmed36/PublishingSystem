...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:key name="affiliations" match="aff" use="@doi"/>
		...
		<ArticleSet>
			<Article>
				<Journal>
					...
					<Issn>
						<xsl:value-of select="$title-meta/issn[@pub-type='epub']"/>
					</Issn>
				...
				<ELocationID EIdType="doi" ValidYN="Y">
					<xsl:value-of select="$article-meta/article-doi[@pub-doi-type='doi']"/>
				</ELocationID>

				<ELocationID EIdType="pii" ValidYN="Y">
					<xsl:value-of select="$article-meta/article-doi[@pub-doi-type='publisher-doi']"/>
				</ELocationID>
